...
function () {
  ...
  _createClass(Model, [{
    ...
    value: function addTodo(todoText) {
      var id = this.todos.length > 0 ? this.todos[this.todos.length - 1].id + 1 : 1;
      var todo = {
        id: id,
        text: todoText,
        completed: false
    ...
    value: function _initLocalListeners() {
      ...
      this.todoList.addEventListener('input', function (event) {
        if (event.target.className === 'editable') {
          _this3._temporaryTodoText = event.target.innerText;
        }
      });
    }
  }, {
...
var Controller = function Controller(model, view) {
  ...
  _defineProperty(this, "handleDeleteTodo", function (todoId) {
    _this5.model.deleteTodo(todoId);
  });

  _defineProperty(this, "handleToggleTodo", function (todoId) {
    _this5.model.toggleTodo(todoId);
  });

  _defineProperty(this, "handleEditTodo", function (todoId, todoText) {
    _this5.model.editTodo(todoId, todoText);
  });
